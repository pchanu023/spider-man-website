            ...
            <div className="flex items-center justify-start p-4">
                <div className="ml-0 md:ml-10">
                    ...
                    <p className="text-sm md:text-lg lg:text-xl text-white mt-4 md:mt-5 leading-relaxed">
                        Tom’s Spider-Man is the most youthful and energetic portrayal, closely resembling the comic book version. Integrated into the MCU, his version of Spider-Man interacts with other Marvel heroes, making him a key figure in the cinematic universe.
                    </p>
                    <button 
